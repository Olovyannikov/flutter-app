...
import 'package:flutter_app/widgets/cardsGridView.dart';
import 'package:flutter_app/widgets/mainButton.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void changeCards() {
    ...
    String cardFourthKey = playingCards.keys.elementAt(
      random.nextInt(playingCards.length),
    );
    playingCards.removeWhere((key, value) => key == cardFourthKey);

    dealersFirstCard = cardOneKey;
    dealersSecondCard = cardTwoKey;

    playersFirstCard = cardThreeKey;
    playersSecondCard = cardFourthKey;
    ...
    if (dealerScore <= 14) {
      ...
      playingCards.removeWhere((key, val) => key == thirdDealersCardKey);
